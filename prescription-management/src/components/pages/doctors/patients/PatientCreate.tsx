...
function PatientCreate() {
     ...
     const handleSubmit = (e: React.FormEvent) => {
          ...
          api.post('create-patient', patient)
               .then((response) => {
                                        ...
                                        <form onSubmit={handleSubmit}>
                                             <div className="mb-3">
                                                  ...
                                                  <select defaultValue={"Select One"} name="user_id" id="user_id"
                                                       ...
                                                       onChange={(e) => setPatient({ ...patient, user_id: parseInt(e.target.value) })}>
                                             ...
                                             <div className="mb-3">
                                                  ...
                                                  <div className="mb-3">
                                                       ...
                                                       <textarea name="address" id="address" className="form-control" rows={3}
                                                            value={patient.address} onChange={(e) => setPatient({ ...patient, address: e.target.value })}></textarea>
                                                  </div>
                                                  ...
                                                  <div className="mb-3">
                                                       ...
                                                       <input type="number" id="phone" name="phone" className="form-control" placeholder="Enter phone"
                                                            value={patient.phone} onChange={(e) => setPatient({ ...patient, phone: parseInt(e.target.value) })}
                                                            required />
                                                  </div>
