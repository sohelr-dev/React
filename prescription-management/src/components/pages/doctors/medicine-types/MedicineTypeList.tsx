...
function MedicineTypeList() {
  ...
  const handleDelete = (deleteId: any) => {
    api
      .delete(`delete-medicine-type?id=${deleteId}`)
      .then((response) => {
  ...
  return (
    <>
      ...
      <Link
        to="/medicine-types/create-medicine-type"
                  ...
                  <tr key={item.id} className="text-center">
                    ...
                    <td>
                      <div className="d-flex justify-content-center gap-2">
                        <Link
                          to={`/medicine-types/details-user/${item.id}`}
                          className="btn btn-outline-primary btn-sm"
                        >
                          <i className="fas fa-eye"></i>
                        </Link>
                        <Link
                          to={`/medicine-types/edit-medicine-type/${item.id}`}
          ...
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                data-bs-dismiss="modal"
                onClick={() => handleDelete(medicineTypeId)}
              >
                Delete
              </button>
            </div>
