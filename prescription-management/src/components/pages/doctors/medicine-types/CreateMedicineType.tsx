...
function CreateMedicineType() {
    ...
    const[medicineType,setMedicineType]=useState<medicineTypes>(medicineTypesDefault);
    useEffect (()=>{
    ...
    const handleSubmit=(e:React.FormEvent)=>{
        ...
        api.post('create-medicine-type',medicineType)
        .then((response)=>{
                ...
                <div className="row justify-content-center">
                    <div className="col-12 col-md-6">
                        <div className="card mt-3 shadow-sm">
                            <h5 className="card-header text-center fs-3">Create Medicine Type</h5>
                            <div className="card-body">
                                <form onSubmit={handleSubmit}>
                                    <div className="mb-3">
                                        <label htmlFor="type_name" className="form-label mb-4"> Name</label>
                                        <input type="text" id="type_name" name="type_name" className="form-control"  placeholder="Enter medicine type" 
                                        value={medicineType.type_name} onChange={(e)=>setMedicineType({...medicineType,type_name:e.target.value})}
                                        required/>
                                    </div>
