...
function Medicines() {
  ...
  const handleDelete = (deleteId: any) => {
    api
      .delete(`delete-medicine?id=${deleteId}`)
      .then((response) => {
  ...
  return (
    <>
      ...
      <Link to="/medicines/create-medicine" className="btn btn-primary mb-4">
        Create{" "}
      </Link>
                  ...
                  <tr key={item.id} className="text-center">
                    ...
                    <td>
                      <div className="d-flex justify-content-center gap-2">
                        <Link
                          to={`/medicines/details-medicine/${item.id}`}
                          className="btn btn-outline-primary btn-sm"
                        >
                          <i className="fas fa-eye"></i>
                        </Link>
                        <Link
                          to={`/medicines/edit-medicine/${item.id}`}
