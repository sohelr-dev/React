...
function UpdateMedicine() {
    ...
    const handleSubmit = ((e: React.FormEvent) => {
        ...
        api.put("edit-medicine", medicineId)
            .then((response) => {
                        ...
                        <div className="card mt-3 shadow-sm">
                            ...
                            <div className="card-body">
                                <form onSubmit={handleSubmit}>
                                    <input type="hidden" name="id" id="id" value={medicineId.id}
                                        onChange={(e) => setMedicineId({ ...medicineId, id: parseInt(e.target.value) })} />
                                    <div className="mb-3">
                                        <label htmlFor="name" className="form-label mb-4">Medicine Name</label>
                                        <input type="text" id="name" name="name" className="form-control" placeholder="Enter medicine Name"
                                            value={medicineId.name}
                                            onChange={(e) => setMedicineId({ ...medicineId, name: e.target.value })}
                                            required />
                                    </div>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="text" id="generic_name" name="generic_name" className="form-control" placeholder="Enter medicine"
                                            value={medicineId.generic_name} onChange={(e) => setMedicineId({ ...medicineId, generic_name: e.target.value })}
                                            required />
                                    </div>
                                    <div className="mb-3">
                                        ...
                                        <input type="text" id="description" name="description" className="form-control" placeholder="Enter medicine"
                                            value={medicineId.description} onChange={(e) => setMedicineId({ ...medicineId, description: e.target.value })}
                                            required />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="medicine_type_id" className="form-label mb-4"> Medicine Type</label>
                                        <select name="medicine_type_id" id="medicine_type_id" className="form-select"
                                            value={medicineId.medicine_type_id || 0}   // Controlled
                                            onChange={(e) => setMedicineId({ ...medicineId, medicine_type_id: Number(e.target.value) })}
                                            required>
