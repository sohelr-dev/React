...
function AppointmentUpdate() {
    ...
    const [appointmentId, setAppointmentId] = useState<appointment>(appointmentDefault);
    useEffect(() => {
    ...
    const handleSubmit = ((e: React.FormEvent) => {
        ...
        api.put("edit-appointment", appointmentId)
            .then((response) => {
                alert(response.data);
                ...
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb mb-0 fs-5">
                        <li className="breadcrumb-item">
                            <Link to="/appointments" className="text-primary text-decoration-none fw-semibold">
                                Appointments
                            </Link>
                        </li>
                ...
                <div className="row justify-content-center">
                    <div className="col-12 col-md-6">
                        <div className="card mt-3 shadow-sm">
                            <h5 className="card-header text-center fs-3">Update Appointment Status</h5>
                            <div className="card-body">
                                <form onSubmit={handleSubmit}>
                                    <input type="hidden" name="id" id="id" value={appointmentId.id} onChange={(e) => setAppointmentId({ ...appointmentId, id: parseInt(e.target.value) })} />
                                    <div className="mb-3">
                                        ...
                                        <select
                                            ...
                                            onChange={(e) => setAppointmentId({ ...appointmentId, status: e.target.value as "pending" | "confirmed" | "completed" | "cancelled" })}
                                            required>
