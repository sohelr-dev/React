...
function UpdateTest() {
  ...
  // console.log(paramId)
  const getTestId = () => {
    api.get(`details-test?id=${paramId}`).then((res) => {
              ...
              <div className="card-body">
                <form onSubmit={handleSubmit}>
                  <input
                    ...
                    value={testId.id}
                    onChange={(e) =>
                      setTestId({ ...testId, id: parseInt(e.target.value) })
                    }
                  />
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      value={testId.name}
                      onChange={(e) =>
                        setTestId({ ...testId, name: e.target.value })
                      }
                      required
                    />
                  </div>
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      value={testId.description}
                      onChange={(e) =>
                        setTestId({ ...testId, description: e.target.value })
                      }
                      required
                    />
                  </div>
