...
function Roles() {
    ...
    const handleDelete = (deleteId: any) => {
        api.delete(`delete-role?id=${deleteId}`)
            .then((response) => {
    ...
    return (
        <>
            ...
            <Link to="/roles/create-role" className="btn btn-primary mb-4">Create </Link>
                                    ...
                                    <tr key={item.id} className="text-center">
                                        ...
                                        <td >
                                            <div className="d-flex justify-content-center gap-2">
                                                ...
                                                <Link to={`/roles/edit-role/${item.id}`} className="btn btn-primary btn-sm" >
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={() => handleDelete(roleId)} >Delete</button>
                        </div>
                    </div>
                </div>
            </div>
