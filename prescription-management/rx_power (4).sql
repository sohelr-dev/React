...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2025 at 09:06 AM
...
(2, 'Dr. Arefin', 'arefin@rx.com\r\n', '', 2, '2025-09-28 19:37:48', 'uploads/users/20251018-052514.jpeg', '25455554'),
(3, 'Dr. Tania', 'tania@rx.com\r\n', '', 2, '2025-09-28 19:37:48', 'uploads/users/20251018-052457.jpg', '25445445'),
(4, 'Patient Ali', 'ali@rx.com\r\n', '123456', 3, '2025-09-28 19:37:48', NULL, NULL),
(5, 'Patient Jannat', 'jannat@rx.com\r\n', '123456', 3, '2025-09-28 19:37:48', NULL, NULL),
(6, 'Dr. Azad', 'azad@rx.com\r\n', '', 2, '2025-09-28 19:37:48', 'uploads/users/20251018-052430.jpg', '01580947'),
...
--
ALTER TABLE `prescription_items`
  ADD CONSTRAINT `prescription_items_ibfk_1` FOREIGN KEY (`dosage_id`) REFERENCES `dosages` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `prescription_items_ibfk_2` FOREIGN KEY (`duration_id`) REFERENCES `durations` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `prescription_items_ibfk_3` FOREIGN KEY (`instruction_id`) REFERENCES `instructions` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
